...
try {
	seedDatabase().then(
		(_success) => {
			...
			console.table(
				[
					{ fullName: "Sam Lavin", email: "sam@example.com", password: "password1234" },
					{ fullName: "John Gjenset ", email: "john@example.com", password: "password1234" },
					{ fullName: "Tom Delande", email: "tom@example.com", password: "password1234" },
					{ fullName: "Paul Mcpherson", email: "paul@example.com", password: "password1234" },
					{ fullName: "Nadia Neuwman", email: "nadia@example.com", password: "password1234" },
					{ fullName: "Billy Campbell", email: "billy@example.com", password: "password1234" },
				],
			)
		},
		(err) => {
